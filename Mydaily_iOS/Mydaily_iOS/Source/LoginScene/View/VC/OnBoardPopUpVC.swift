...
class OnBoardPopUpVC: UIViewController{
    static let identifier = "OnBoardPopUpVC"
...
extension OnBoardPopUpVC: UICollectionViewDataSource{
...
extension OnBoardPopUpVC: UICollectionViewDelegateFlowLayout {
